<template>
    ...
    <div class="max-w-screen-lg px-4 sm:px-6 text-gray-800 sm:grid md:grid-cols-4 sm:grid-cols-2 mx-auto">
        <div class="p-5">
            <h3 class="font-bold text-md text-indigo-600">Greig McMahon Web Development</h3>
            <img src="https://www.greigmcmahon.com/assets/images/001.jpg" alt="Post Thumbnail">
        </div>
        <div class="p-5">
        ...
        <div class="p-5">
            ...
            <a class="my-3 block" href="/#">6/1, Valetta Stree, Melbourne, Vic
                <span class="text-teal-600 text-xs p-1"></span></a><a class="my-3 block" href="/#">info@greigmcmahon.com
